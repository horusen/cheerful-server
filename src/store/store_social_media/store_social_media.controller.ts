...
export class StoreSocialMediaController {
  constructor(private readonly storeSocialMediaService: StoreSocialMediaService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateStoreSocialMediaDto: UpdateStoreSocialMediaDto) {
